...
def get_args():
	...
	return GENOMEFA, BLAST, LIB, LBUFFER, RBUFFER, ALIGN, TRIMAL, EMBOSS, MAXITERS, LOG, BEDS
...
def EXTRACT_BLAST_HITS(GENOME, BLAST, LBUFFER, RBUFFER, BEDS):
##Read in blast data
...
##Get input arguments
	...
	GENOMEFA, BLAST, LIB, LBUFFER, RBUFFER, ALIGN, TRIMAL, EMBOSS, MAXITERS, LOG, BEDS = get_args()
...
##Extract hits and combine them with the TE out files if flagged
	...
	EXTRACT_BLAST_HITS(GENOMEFA, BLAST, LBUFFER, RBUFFER, BEDS)
