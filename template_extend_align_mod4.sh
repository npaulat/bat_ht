...
EXTENSIONWORK=$THISGENOME/extensionwork_redo
...
REDUCED_BLAST_DIR="/lustre/scratch/npaulat/RayLib-Masking/blast_90_reduced"
cp $REDUCED_BLAST_DIR/$TE_ID"_"$SUBNAME".reduced.out" .
REDUCED_BLAST=$TE_ID"_"$SUBNAME".reduced.out" 
...
python /lustre/scratch/npaulat/yin_yang/extract_all.py -g $SUBNAME".fa" -b $THISGENOME/blastfiles/$REDUCED_BLAST -l $CONSENSUSSEQS -lb 500 -rb 500 -a n -e n -t n
