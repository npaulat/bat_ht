...
PROCESSEDBEDSPATH = '/lustre/scratch/npaulat/paulat_beds2/' + CATEGORY + '_cat_files'
WORKPATH = '/lustre/scratch/npaulat/paulat_beds2/plots'

## Decide what class of TE you want to plot
#TETYPES = ['DNA'] #for testing
#TETYPES = ['other_DNA'] #for testing
#TETYPES = ['DNA', 'LINE', 'RC', 'SINE', 'LTR']
TETYPES = ['Helitron', 'TcMariner', 'hAT', 'PiggyBac', 'other_DNA']
...
##Function to convert capitalize each word in figure title
##Note: do not want this for hAT or piggyBac figures
