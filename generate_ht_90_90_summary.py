...
out_dir = "/lustre/scratch/npaulat/yin_yang/external_ht"
blast_dir = "/lustre/scratch/npaulat/yin_yang/external_ht/blast_out"
taxa_files = "/lustre/scratch/npaulat/yin_yang/external_ht/non_mammal"
summary_file = os.path.join(out_dir, "nonmammal_ht_3_90_sp_hits_summary.csv")
te_list_file = "/lustre/scratch/npaulat/yin_yang/external_ht/ht_te_list"
...
#BLAST custom output 6 format: qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore staxids sscinames scomnames
#want staxids -> field 13 (12 if index starts at 0)
...
for te in te_dict:
	...
	taxa_file = os.path.join(taxa_files, te) + "_90.nonMammal"
