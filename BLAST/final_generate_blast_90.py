...
OUTDIR = "/lustre/scratch/npaulat/RayLib-Masking/blast_90/"
INPUT1 = "/lustre/scratch/npaulat/RayLib-Masking/final_sp_TE_heatmap_min90_DNA_RC_max100sp.csv"
INPUT2 = "/lustre/scratch/npaulat/RayLib-Masking/final_heatmap_new_headers"
OUTPUT1 = os.path.join(OUTDIR, "blast_all_TEs_all_mammals_mkdb.sh")
OUTPUT2 = os.path.join(OUTDIR, "blast_all_TEs_all_mammals.sh")
GENOME_DIR = "/lustre/scratch/npaulat/RayLib-Masking/assemblies/"
TE_DIR = "/lustre/scratch/npaulat/RayLib-Masking/te_fastas/"
	...
	with open(OUTPUT2, "w+") as file2:
		...
		for TE in TE_DICT:
			...
			for SPECIES in TE_DICT[TE]:
				...
				file2.write('/lustre/work/aosmansk/apps/ncbi-blast-2.11.0+/bin/blastn -query ' + TE_FA + ' -db ' + SPECIES + ' -perc_identity 90 -qcov_hsp_perc 90 -out ' + OUT_FILE1 + ' -outfmt 11\n')
